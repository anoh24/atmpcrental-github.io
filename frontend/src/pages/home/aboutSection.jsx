...
const AboutUs = () =>{
    return(
        <section className="bg-black relative z-0 py-16 md:px-10 lg:px-20">
            <div className=" bg-black p-10 mx-auto max-w-7xl text-center">
                <h2 className=" text-4xl font-bold text-white-700 mb-4">
                    About Us
                </h2>
                ...
                <div className="grid grid-cols-1 p-4 md:grid-cols-3 gap-6">
                    <div className="bg-black p-4 rounded-xl shadow hover:shadow-md transition">
                        <h3 className="text-xl font-semibold text-white-700 mb-2">
                        Mision
                        </h3>
                        <p className="text-md text-left text-gray-200 mb-8">
