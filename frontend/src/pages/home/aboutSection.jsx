...
const AboutUs = () =>{
    return(
        <section className="relative z-0 py-16 md:px-10 lg:px-20">
            <div className="p-10 mx-auto max-w-7xl text-center">
                ...
                <div className="grid grid-cols-1 p-4 md:grid-cols-3 gap-6">
                    <div className="p-4 rounded-xl shadow hover:shadow-md transition">
                        ...
                        <p className="text-md text-left text-gray-800 mb-8">
